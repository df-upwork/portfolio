# 1. `᛭T`
На картинке показано, как фрилансер на Upwork может быстро узнать количество проектов в своём собственном портфолио.
Опиши это в виде инструкции на английском языке.

# 2. Источники информации
## 2.1.
Используй авторитетные источники информации на английском языке, относящиеся к предметной области задачи.
...
# 4. Правила ответа
## 4.1.
Инструкция должна быть на аглийском языке.

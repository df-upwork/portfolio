...
## 2.4. 
The fixed limit for the maximum size of HTTP response headers from the backend is **8KB**, according to Oracle: [support.oracle.com/knowledge/Oracle%20Cloud/2603461_1.html](https://support.oracle.com/knowledge/Oracle%20Cloud/2603461_1.html)

...
## 2. Reasons why **other structures do not satisfy** either **your requirements** or the **expectations of angel investors**
### 2.1. Promissory Note
...
## 3. With `PE`, it is necessary to understand and accept the **associated compromises** clearly
### 3.1.
...
## 4. My recommendations for the Phantom Equity Agreement (`PEA`)
### 4.1. 
...
# 3.
⊤ (`S` — это решение изложенной в `T` задачи)

...
### 19.8.
Вариант должен быть тёплого цвета, не холодного.
Вариант должен обладать внутренней энергией (например, как картины Ротко).
Вариант должен привлекать `C`, обращать его внимание.

  ...
  <defs id='defs1'>
	...
	>
		...
		>
			...
			<tspan class='p12 p2' id='L2' sodipodi:role='line' y='70'>legislative, zoning,</tspan>
			<tspan class='p12 p2' id='L3' sodipodi:role='line' y='92'>wastewater discharge</tspan>
			<tspan class='p3' id='L4' sodipodi:role='line' y='122'>barriers for</tspan>
			<tspan class='p12 p1' id='L5' sodipodi:role='line' y='156'>alkaline hydrolysis</tspan>
			<tspan class='p3' id='L6' sodipodi:role='line' y='186'>in Massachusetts</tspan>
		</text>
		<rect
			height='211.66666'
			id='rect1'
...
#
Когда я удаляю `style='font-size:22.5778px;'` из `Fᨀ`, это приводит к уменьшению междустрочных интервалов.
Почему?
Если это происходит из-за `line-height`, то какую роль тогда играют значения `y` у строк?

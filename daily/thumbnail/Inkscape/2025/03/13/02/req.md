## 1.
Я пытаюсь установить Inkscape 1.4 на Windows 10.

## 2.
Первый же запуск приводит к сбою: «The code execution cannot proceed because liblcms2-2.dll was not found».

## 3. 
Напиши пошаговую инструкцию для устранения сбоя пункта 3.
